               ...
               <table id="listVentas" class="table table-striped table-bordered" style="color: #000">
                  <thead>
                     <tr>
                        ...
                        <th nowrap scope="col">Dis</th>
                        <th nowrap scope="col">Adulto Mayor</th>
                        <th nowrap scope="col">Tipo de pago</th>
                        <th nowrap scope="col">Fecha</th>
                        <th nowrap scope="col">Cantidad</th>
                        <th nowrap scope="col">Descuento</th>
                        <th nowrap scope="col">Total</th>
                        <th nowrap scope="col">Procesos</th>
                     </tr>
                  </thead>
               ...
               <div class="modal-body">
                  <div class="row">
                     ...
                     <div class="col-md-12 mb-2">
                        ...
                        <input type="number" class="form-control iptLogin" id="precioPlato"  placeholder="Precio del plato" disabled />
                     </div>
                     ...
                     <div class="col-md-12 mb-2">
                        ...
                        <input type="number" class="form-control iptLogin" id="cantidad"  placeholder="Ingrese cantidad a comprar" />
                     </div>
                     <div class="col-md-12 mb-2">
                     ...
                     <div class="col-md-12 mb-2">
                        ...
                        <input type="number" class="form-control iptLogin" id="descuento"  placeholder="Descuento" disabled/>
                     </div>
                     <div class="col-md-12 mb-2">
                        <label for="" class="form-label lblLogin">Subtotal</label>
                        <input type="number" class="form-control iptLogin" id="subtotal"  placeholder="Subtotal" disabled/>
                     </div>
                     <div class="col-md-12 mb-2">
                        <label for="" class="form-label lblLogin">IVA</label>
                        <input type="number" class="form-control iptLogin" id="iva"  placeholder="IVA 12%" disabled/>
                     </div>
                     <div class="col-md-12 mb-2">
                        <label for="" class="form-label lblLogin">Total</label>
                        <input type="number" class="form-control iptLogin" id="total"  placeholder="Total a pagar" disabled/>
                     </div>
                  </div>
               </div>
