               ...
               <div class="modal-body">
                  <div class="row">
                     ...
                     <div class="col-md-12 mb-2">
                        ...
                        <input type="number" class="form-control iptLogin" id="precioPlato"  placeholder="Ingrese precio del plato"/>
                     </div>
                     <div class="col-md-12 mb-2">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <div class="row">
                     ...
                     <div class="col-md-12 mb-2">
                        <label for="" class="form-label lblLogin">Precio</label>
                        <input type="number" class="form-control iptLogin" id="precioPlatoEdit"  placeholder="Ingrese precio del plato"/>
                     </div>
                     <div class="col-md-12 mb-2">
                        <label for="" class="form-label lblLogin">Tipo</label>
