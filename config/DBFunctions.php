<?php
   ...
   class DBFuntions
   {
      ...
      public function verifyUser(
         ...
         $stmt = $this->con->prepare("SELECT cedula FROM usuariosl WHERE cedula = ?");
      ...
      public function saveUser(
         ...
         $stmt = $this->con->prepare("INSERT INTO usuariosl(cedula, apellidos, nombres, telefono, direccion, genero, password) VALUES (?, ?, ?, ?, ?, ?, ?)");
      ...
      public function Login(
         ...
         $stmt = $this->con->prepare("SELECT * FROM usuariosl WHERE cedula = ?");
         $stmt->bind_param('s', $cedula);
         $stmt->execute();
         $result = $stmt->get_result();
      ...
      {
         $stmt = $this->con->prepare("SELECT cedula, apellidos, nombres, telefono, direccion, genero FROM usuariosl WHERE NOT cedula = ?");
      ...
      public function deleteUser(
         ...
         $stmt = $this->con->prepare("DELETE FROM usuariosl WHERE cedula = ?");
         $stmt->bind_param('s', $cedula);
      ...
      public function allVentas()
      {
         $stmt = $this->con->prepare(" SELECT
                                          ...
                                          CONCAT(usuariosl.apellidos, ' ', usuariosl.nombres) AS nameVendedor,
                                          platos.nombrePlato, 
                                          ventas.discapacidad,  
                                          ventas.mayorEdad, 
                                          ventas.tipoPago, 
                                       ...
                                       FROM
                                          ...
                                          usuariosl
                                          ON 
                                             ventas.cedUsuario = usuariosl.cedula
                                          INNER JOIN
                                          clientes
                                          ON 
